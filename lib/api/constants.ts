...
/**
 * Cache tag carried by every *time-tiered* upstream read, on top of any
 * specific tags.
 *
 ...
 *
 * The one exclusion is the content-addressed half of the cache — anything on
 * `TTL.frozen`, whose URL already encodes which bytes it holds. See the tag
 * assembly in `taggedFetch` for why expiring those buys nothing.
 *
