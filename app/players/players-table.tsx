      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-line px-3 py-2.5">
        <label>
          ...
          <input
            ...
            className="w-48 rounded border border-ink-3/50 bg-panel-2 px-2.5 py-1.5 text-[12px] text-ink placeholder:text-ink-3 focus:border-accent/50 focus:outline-none"
          />
        </label>
